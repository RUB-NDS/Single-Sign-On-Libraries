 ...
 *         &lt;element name="samlSchema_url" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
...
public class SamlVerificationParametersType {
    ...
    protected List<String> samlSchemaUrl;
     ...
     * 
     */
    public List<String> getSamlSchemaUrl() {
        if (samlSchemaUrl == null) {
            samlSchemaUrl = new ArrayList<String>();
        }
        return this.samlSchemaUrl;
    }
